/* @ts-self-types="./img2bez_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function traceToGlif(image_bytes, config_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passArray8ToWasm0(image_bytes, wasm.__wbindgen_malloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('img2bez_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
