...
export const __wbg_ntffont_free: (a: number, b: number) => void;
export const ntffont_alphabet: (a: number) => [number, number];
export const ntffont_clear_node_offsets: (a: number) => void;
export const ntffont_insert_word_trace: (a: number, b: number, c: number, d: number, e: number) => number;
