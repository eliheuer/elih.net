...
The sums have a hierarchy of their own, like the grid. A pure power
is cleanest: 128. Two terms is next: 96 = 64 + 32. Three is
acceptable: 112 = 64 + 32 + 16. Between sums with the same number of
terms, adjacent powers are cleaner: 96 = 64 + 32, n plus half of n,
over 80 = 64 + 16, n plus a quarter of n. The goal is the same as the
grid's: free semantic labels, read straight out of the outlines.
