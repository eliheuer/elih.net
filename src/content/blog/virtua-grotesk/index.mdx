...
description: 'Virtua Grotesk, a typeface drawn on a self-labeling grid system, and the small neural network learning to draw it.'
date: 2026-07-20
...
Virtua Grotesk is a typeface drawn on a **self-labeling grid
system**. Point placement defaults to an 8-unit grid, with small
optical corrections dropping to a 2-unit subgrid. The grids record most
...
<li><a href="#03-self-labeling-grid-systems"><span class="n">03</span>Self-Labeling Grid Systems</a></li>
...
[img2bez](/blog/img2bez), a tracer that
...
and harness that Virtua Grotesk uses, including
[Runebender](https://runebender.org).
