...
<p class="font-mono text-sm" style="color: #ff4535">NOTE: this post is a draft and still being edited. Feedback welcome: eli@elih.net</p>

Virtua Grotesk is a typeface I am designing on a multi-layer semantic powers-of-two grid system, and if
