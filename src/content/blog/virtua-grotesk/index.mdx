...
![The word Grid set large in the default source selected by Virtua Grotesk's designspace: translucent glyph fills and outlines progressing from red-orange at the left to yellow-orange at the right, with matching outline-colored Bézier handles, green 8-unit structural points and red 2-unit optical-correction points, blue metric and advance boundaries, compact sidebearing and ink-width measurements below, and the title Virtua Grotesk: Grid Systems as Datasets spanning the full width along the bottom margin.](./share-card.png)
