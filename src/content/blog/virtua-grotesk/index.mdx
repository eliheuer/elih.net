...
Like the nested grid, the length of the sum is a free label and a visual design constraint.
...
and it is enforced programatically. From the repo root, `make
...
be put to work reviewing and fixing whatever the QA grader flags.
