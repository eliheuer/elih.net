...
There are two ideas in this design system: a self-labeling grid, and a
base to draw it in. Start with the base, because it is the part you can
see. Virtua Grotesk is drawn against powers-of-two, not the base-10 grid of Replica,
...
The elegant part is that this labels itself, which is the sense in
which the grid is **self-labeling**. Because everything structural
...
material for a model that could eventually make those corrections on
its own.
