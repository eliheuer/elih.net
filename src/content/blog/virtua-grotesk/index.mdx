...
The current model, v0.7, now statistically ties the dumb baseline of
section 06 on held-out glyphs: 33.9 font units of error per coordinate
...
![Held-out review sheet: for the glyphs K, E, M, n, b, c and a, three rows show the human-drawn Regular input in white, the model-generated Bold in red, and the human-drawn Bold reference in gray. The a column's reference cell reads "never drawn": the Bold master never had a real a.](./fig-model-review.png)
...
![The letter a twice: the hand-drawn Regular in white, and beside it the model-generated Bold in red, the first real Bold a in the design, drawn by the model from the Regular input.](./fig-model-bolden-a.png)
