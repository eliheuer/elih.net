...
glyphs, structurally identical between Regular and Bold. Training now
runs in two stages: the model first pretrains on glyphs traced from
OFL fonts in the Google Fonts collection, then finetunes on Virtua
itself. Section 07 measures what the pretraining bought.
