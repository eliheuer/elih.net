...
are in font units. MAE measures error at the points, Chamfer measures
error along the drawn shape, and IoU measures how much the filled
glyphs overlap. FID, the usual generative-image metric, needs far
more than ten samples, so it is skipped.
