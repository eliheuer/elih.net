...
sources, every dimension anchored to real outline coordinates: the
whole Latin system, the lowercase up close, the two masters side by
side, and the same system carrying Arabic.
