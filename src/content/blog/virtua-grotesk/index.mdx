...
glyphs, structurally identical between Regular and Bold. Since v0.8
the model also pretrains on glyphs from OFL fonts in the Google Fonts
collection before the Virtua-12M-v0.1 finetune; section 07 reports
what that bought.
