...
more closely than I planned. The first overnight run memorized the data (loss
0.07 over a few thousand sequences); the fixes were the recipe's standard ones,
