...
lands on records what kind of decision it was. The tiers are ruled in
powers of two, from the em itself, 1024 = 2^10, on down, and every
dimension in the design reaches for an elegant binary number: stems of
96, chamfers of 16, sidebearings of 48 = 32 + 16. The base is part of
the labeling, not just taste: in binary, the tier a value sits on can
be read straight off its digits, so the powers of two make the
self-labels machine-readable. If you are reading this
on [elih.net](/), it
