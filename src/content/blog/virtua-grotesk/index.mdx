...
grades every measurement against this system, and an AI agent harness
...
short sums of powers-of-two. The sums are a second semantic
hierarchy, parallel to the nested grid: the fewer the powers, the
more structural the value. The score is binary popcount, the count
...
the model also pretrains on glyphs from other OFL fonts before the
Virtua finetune; section 07 reports what that bought.
