...
follows the system. Points must sit on the 2-grid, on-curve points on
8 or off by exactly 4, advances on 8, and handle lengths and
structural spans are scored as short sums of powers-of-two. Point an
...
The four dimension sheets below are measured directly from the
