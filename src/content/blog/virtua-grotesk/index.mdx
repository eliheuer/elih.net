...
![Three large n outlines drawn with designbot on an 8-unit grid: the n at Regular, at the 1/2 interpolation between Regular and Bold, and at Bold, with all on-curve and off-curve points marked. Points are colored by grid level, green on the 8-unit structure grid and red off 8 on the 2-unit correction grid. Every point of the interpolated middle n lands on a grid intersection, and the stem steps 96, 144, 192, so the intermediate weight is a clean, grid-native glyph.](./fig-interp-outlines.png)
