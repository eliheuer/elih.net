...
{/* TODO: designbot figure: scaling-robustness matrix. Rows: grid
levels 64 / 8 / 2 (metrics, structure, correction); columns: pixel
sizes 12, 14, 16, 18, 24, 32; each cell marked exact or rounded. A
1024-em panel beside a 1000-em panel that is rounded everywhere. */}

{/* TODO: designbot figure: the same x-height line at 16 px on both
ems, on an enlarged pixel grid: 576/1024 landing on the 9-pixel row,
562/1000 landing at 8.992 px across a row boundary. */}
