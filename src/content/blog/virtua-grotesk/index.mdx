...
language. Pointed at the Google Fonts OFL library, this is the
long-term data plan: a growing corpus of grid-native families, every
one OFL, with a provenance manifest. No scraping, training data you
could audit glyph by glyph. It also answers the charge that the grid
