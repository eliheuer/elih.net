...
system**. The drawing grid comes in nested tiers, ruled in powers of
two from the em on down, and the tier a point lands on records what
...
value's tier can be read straight off its digits. If you are reading
