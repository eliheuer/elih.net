...
surveying the field, names both problems directly: the models work on raster
images with a post-hoc vectorization step, and the training corpora are
polluted found data assembled by people without typographic expertise.
