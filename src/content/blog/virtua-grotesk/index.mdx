...
handwriting. That is fine for a rasterizer. It is a problem for an AI
production pipeline: the network trains on the sources, the linter
checks generated glyphs, and the agent edits the files through a
harness. Today's font AI trains on exactly this accidental data:
scraped fonts and Google Fonts as they come, heterogeneous in every
