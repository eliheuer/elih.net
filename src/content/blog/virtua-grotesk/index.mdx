...
language. That is how the model's pretraining data was made: other
OFL families, traced onto the grid, so the model sees more than one
designer's hand before it ever meets Virtua Grotesk.
