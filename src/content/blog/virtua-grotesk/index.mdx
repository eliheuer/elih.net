...
language. Run it over the whole Google Fonts OFL library and you get
the long-term data plan: a growing corpus of grid-native families,
every one OFL, with a provenance manifest. No scraping, training data
you could audit glyph by glyph. It also answers the charge that the grid
is one foundry's private convention: any OFL family can be brought
onto it.
