...
<li><a href="#7-variable-fonts-masters-that-interpolate"><span class="n">7</span>Variable Fonts: Masters that Interpolate</a></li>
<li><a href="#8-an-api-for-other-peoples-tools"><span class="n">8</span>An API for Other People's Tools</a></li>
<li><a href="#9-measuring-draws-like-a-designer"><span class="n">9</span>Measuring &ldquo;Draws Like a Designer&rdquo;</a></li>
<li><a href="#10-early-days-and-an-invitation"><span class="n">10</span>Early Days, and an Invitation</a></li>
</ol>
</nav>
...
Profile selection is currently manual. Planned work adds automatic classification in the default mode, using inexpensive signals such as resolution and an edge-sharpness measure, along with dedicated profiles for inputs a single setting handles poorly — blurry photographs of printed specimens, or low-resolution legacy web images. Each new profile requires tuning against a labeled corpus of its input class, which is pending eval-harness work.

### 7. Variable Fonts: Masters that Interpolate
...
### 8. An API for Other People's Tools
...
### 9. Measuring "Draws Like a Designer"
...
### 10. Early Days, and an Invitation
