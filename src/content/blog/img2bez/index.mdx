...
What I want is more specific than a general-purpose tracer:

- **Integration.** A Rust library I can easily embed in Rust-based font editors like Runebender.
- **Tunable with agent loops.** Something I can push toward concrete goals automatically, with autoresearch and agent loops (more on that below).
...
An outline can match the bitmap to a tenth of a pixel and fail all of these.
