...
Below is an interactive demo of img2bez compiled from Rust to WASM. Click **Trace** to vectorize a raster image and see the outline it produces. To try your own glyph, drop an image onto the app (or use the picker in the corner). The Profile, Style, and Output controls tune the trace along the three axes described below, and run the same WASM the rest of this post explains.
...
### 14. Early Days, and an Invitation
