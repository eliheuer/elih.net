...
description: 'A Rust autotracer whose objective is type-design structure, not geometric error, developed against hand-drawn references with an eval harness. How it works, why Potrace and diffvg solve a different problem, and how to measure "draws like a designer."'
date: 2026-06-16
