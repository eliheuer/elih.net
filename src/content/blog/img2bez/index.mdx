...
Below is an interactive demo of img2bez compiled from Rust to WebAssembly. Click **Trace** to vectorize a raster image and see the outline img2bez produces; scroll to zoom and drag to pan. To try your own glyph, drop an image onto the app (or use the picker in the corner). This runs with the default settings, which can be tuned for better output depending on image quality and design style.
