...
training corpus stops at three-letter words for now, so letters
inside the longer words of the basmala sit in contexts the model has
not seen. Those words render rough until the corpus grows.
