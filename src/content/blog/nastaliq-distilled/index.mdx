...
Graphite and [DecoType’s](https://decotype.com/) Advanced Composition Engine go
beyond OpenType Layout. Graphite supports more complex shaping rules. DecoType’s
engine powered [Tasmeem](https://decotype.com/pdfs/Tasmeem_Manual.pdf), a
proprietary InDesign extension for advanced Arabic composition. Both define
behavior through rules and require specialized software, which limits where
they can be used.

Neural fonts also need engine support for now. The long-term goal is not another
specialist extension, but a format that could replace OpenType or at least gain
broad support on the web and in graphics software. Beyond Nasta’liq, it could
support new kinds of typography for branding, advertising, and cultural
production. These uses could provide stronger economic incentives for adoption.

OpenType can do a lot, but building a good Nasta’liq font with it is expensive
and time-consuming. The shortage of good OpenType Nasta’liq fonts, relative to
the style’s cultural importance, suggests that this work is often uneconomical
and too difficult for hobbyists.
