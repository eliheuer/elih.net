...
words. Unlike a font designed from the ground up for this format, it cannot yet
treat a whole line as one composition. Try it in the interactive demo below.
