...
Gulzar's license declares no Reserved Font Name, so a new name for
the distilled font is a courtesy rather than a requirement. It will
ship under the OFL, with Gulzar's copyright notice, and it will take
its own name when it ships.
