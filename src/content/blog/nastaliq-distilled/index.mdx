...
the concept and was easy to dismiss as a toy tech demo. This post shows that a
1.36-million-parameter neural font can reproduce much of Gulzar’s output. It
still fails on many unseen words and does not treat a whole line as one
composition.
