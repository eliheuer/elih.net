...
extreme example, but the compositions above use the same principle more subtly,
...
For this experiment, I used [Gulzar](https://gulzarfont.org/), a contemporary
Urdu Nasta’liq typeface intended for sustained reading. It is not a perfect
match for the historical examples, but it is the best available open option. I
could not find another usable OpenType Nasta’liq font under the OFL.
