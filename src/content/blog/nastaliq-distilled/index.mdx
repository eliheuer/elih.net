...
Neural fonts also need engine support. Unlike rule-based font systems, they
learn from examples. This could let them reproduce behavior that is too complex
