...
it has not been trained on render rough.
...
glyphs, at these positions. The answers are deterministic, and the
questions are free. That is what makes distillation cheap.
