...
The dataset contains 91,390 training records. After the glyphs in each record
are assembled, there are **1,150 distinct shapes**. The figure below shows the
108 shapes associated with خ.
...
Five-letter strings would add another 28.6 million and still miss longer-range
effects. A production model should instead train on representative text and add
examples where its output differs from the teacher. Basic joining and
