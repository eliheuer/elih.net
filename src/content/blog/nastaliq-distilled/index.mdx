...
Neural fonts also need engine support, but they learn from examples instead of
following rules. This could let them reproduce behavior that is too complex to
specify as rules.

My long-term goal is a format that could replace OpenType, not another
specialist extension. It could support new kinds of typography for branding,
advertising, and cultural production. OpenType can do a great deal, but building
a good Nasta’liq font with it is expensive. The shortage of good OpenType
Nasta’liq fonts, relative to the style’s cultural importance, suggests that the
current approach is often uneconomical.
